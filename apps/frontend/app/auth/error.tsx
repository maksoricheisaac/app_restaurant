...
export default function AuthError({
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8 text-center gap-5 bg-gradient-to-br from-slate-50 via-white to-orange-50">
      ...
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1 max-w-sm">
          {error.message || "Impossible de charger cette page de connexion."}
        </p>
      </div>
