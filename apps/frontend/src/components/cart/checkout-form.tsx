...
export function CheckoutForm({ isOpen, onClose, onBack }: CheckoutFormProps) {
  ...
  const selectedDeliveryZone = deliveryZones?.find((zone: any) => zone.id === selectedDeliveryZoneId);
              ...
              <>
                <div className="space-y-2">
                  ...
                  <Select onValueChange={(value) => form.setValue('deliveryZoneId', value)} defaultValue={form.getValues('deliveryZoneId')}>
                    ...
                    <SelectContent>
                      {deliveryZones?.map((zone: { id: Key | null | undefined; name: string | number | bigint | boolean | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | Promise<string | number | bigint | boolean | ReactPortal | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | null | undefined> | null | undefined; price: number; }) => (
