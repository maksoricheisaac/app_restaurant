...
import { useIngredients, useCreateRecipe, useUpdateRecipe } from "@/hooks/api/useInventory";
import { useMenuItems } from "@/hooks/api/useMenu";
import type { MenuItem } from "@/types/menu";
import type { Recipe, RecipeFormData, Ingredient } from "@/types/inventory";
...
export function RecipeForm({
  ...
  const { data: menuData } = useMenuItems({ page: 1, perPage: 100 });
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} value={field.value}>
                    ...
                    <SelectContent>
                      {ingredients
                        .filter((ingredient: Ingredient) => ingredient.isActive)
